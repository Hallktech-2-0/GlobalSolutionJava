...
public class Hospital {
	...
	public Hospital(String unidadeId, String nomeUnid, String enderecoUnid, String telefoneUnid, String email,
			String site) {
		super();
	...
	public String toString() {
		return "Hospital [unidadeId=" + unidadeId + ", nomeUnid=" + nomeUnid + ", enderecoUnid=" + enderecoUnid
